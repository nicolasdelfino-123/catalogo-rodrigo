                ...
                <div className="relative">
                    ...
                    >
                        {brands.map((brand) => {
                            ...
                            const isKenzo = normalizeBrandText(brand.label) === "kenzo";
                            const isMontale = normalizeBrandText(brand.label) === "montale";
                                ...
                                >
                                    <span className="home-brand-circle relative grid h-[104px] w-[104px] place-items-center rounded-full border border-[#b8b8b8] bg-black p-[3px] shadow-[0_18px_42px_rgba(0,0,0,0.28)] transition duration-500 group-hover:-translate-y-1 group-hover:border-[#d8d8d8] group-hover:shadow-[0_24px_54px_rgba(0,0,0,0.38)] sm:h-[120px] sm:w-[120px]">
                                        <img
                                            ...
                                            alt={brand.label}
                                            className={`${isArmaf || isKenzo || isMontale ? "home-brand-logo-original" : "home-brand-logo"} mx-auto rounded-full bg-transparent object-contain object-center transition duration-500 group-hover:scale-[1.035] ${logoSizeStyle ? "" : `h-full w-full ${logoPaddingClass}`}`}
                                            style={logoSizeStyle}
                                            loading="lazy"
                                        />
                                    </span>
